...
$(document).ready(function(){
    //customer utilities
    $("#branch,#email,#name,#contact,#subject,#description").keyup(function(){
    ...
    $("#submit").mouseover(function()//reverifies correct inputs
    {
        ...
        checkSubject=finalValidateSubject();
        if(checkName&&checkContact&&checkEmail&&checkBranch&&checkSubject)
        {
         checkFinal=true;
        }
        if(!checkFinal)
        {
            ...
            if(!checkSubject)
            {
            	...
            	$.notify("Subject entered was Incorrect Please re enter again","error");//Incorrect Subject
            }
...
checkSubject=finalValidateSubject();//validates subject
if(checkName&&checkContact&&checkEmail&&checkBranch&&checkSubject)
{
